    ...
    <form novalidate @submit.prevent="addItem"
      ...
      <div class="flex flex-col">
        <input v-model="name" placeholder="add a name" id="name-input"
          class="px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-gray-900" />
      ...
      <button type="submit"
        class="px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Add
        Item
      </button>
    </form>
  </main>
